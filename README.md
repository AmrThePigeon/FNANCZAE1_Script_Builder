...
```
rm -f test.sh >/dev/null 2>&1 && wget https://raw.githubusercontent.com/AmrThePigeon/FNANCZAE1_Script_Builder/refs/heads/main/fnancz-installer1.sh && chmod +x fnancz-installer1.sh && ./fnancz-installer1.sh
```
