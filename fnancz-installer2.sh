...
scriptdeletion() {
rm -f "$scriptlocation/fnancz-installer2.sh"
}
...
wget https://raw.githubusercontent.com/AmrThePigeon/FNANCZAE1_Script_Builder/refs/heads/main/libNekoPresence_x64_linux_arm64-v8a.so --no-cache
